  ...
  return (
    <div>
      ...
      <div
        ...
        <div
          className="text-gray-50 w-full h-full flex flex-col justify-center items-center"
          style={{ background: "rgba(14, 5, 41, 0.5)" }}>
          <p
            className="mb-3 font-mono text-gray2"
          ...
          <div
            className="flex items-center gap-3 mt-3 text-gray2 font-semibold"
            style={{ fontFamily: "Josefin Sans" }}>
      ...
      <section className="bg-white py-20 px-4 lg:py-[120px] overflow-hidden relative z-10 rounded">
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p
                  className="text-base leading-relaxed mb-9 font-semibold text-body-color"
                  style={{ fontFamily: "Josefin Sans" }}>
                  If you're ready to experience a gastronomic delight like never
                  before, we're here to make it happen. At De-Angels Bar and
                  Grills, we believe in crafting exceptional moments through our
                  delectable cuisine and warm hospitality. Reach out to us today
                  to reserve a table, plan a special event, or simply indulge in
                  a culinary journey that tantalizes your taste buds and soothes
                  your soul. We look forward to serving you.
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p
                      className="text-base text-body-color font-semibold"
                      style={{ fontFamily: "Josefin Sans" }}>
                      Plot f16, F296+WM9 Housing Area B, New Owerri 460281,
                      Owerri, Imo
                    </p>
                  </div>
                </div>
